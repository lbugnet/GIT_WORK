...
;---------------------------------------------------
READ_KEPLER_DIR,path_str,files_arr,id_stars_arr,wild=wild_str, length=9
...
FOR ns = INIC, n_stars_tot-1 DO BEGIN
	...
	region,freq_inic_gr,freq_fin_gr,freq_org,power,xmat,ymat,out_metrics=out_metrics
	region,freq_inic_gr_ns,freq_fin_gr_ns,freq_org,power,xmat,ymat,out_metrics=out_metrics_ns
...
save,file=path_org_str+file_output_str,output_a2zp, slope_fit
