pro compute_metric_line_K2_C4
device, decomposed=0
loadct, 39

;file 1: Contient les etoiles de K2C4
restore, '/Users/lbugnet/DATA/METRIC/K2/C4/C4RESULTS_A2Zp_variab_metrics_Lor_K2_C4.sav', /verbose
...
;file 3: courbes de lumiere a transformer en puissance
readcol, '/Users/lbugnet/DATA/METRIC/K2/C4/A2Z_results_K2_C4_Everest_2017_04_06.txt',kic_s, numax, err_numax,dnu, err_Dnu, Amax, err_Amax,  format='A,D,D,D,D,D,D', /silent
...
save, file='/Users/lbugnet/DATA/METRIC/K2/C4/metric_all_stars_K2_C4.sav', xx, yy, res, slope_fit, output_a2zp, output_resize,  out ;=(stars not in common) 
save, file='/Users/lbugnet/DATA/METRIC/K2/C4/masses_stars_K2_C4.sav'    , xx, yy, residuals, threshold, flag, kic_s, numax, dnu
;save, file='/Users/lbugnet/DATA/METRIC/K2/C4/stars_OK_K2_C4.sav'    , xx_ok, yy_ok, residuals, threshold, slope_fit, res


;SAVE LOW STARS
;w_low=where(flag eq 1)
;  close,1
;  openw,1,'/Users/lbugnet/DATA/METRIC/K2/C4/low_stars_s.txt'
;  close,1
;  openw,1, '/Users/lbugnet/DATA/METRIC/K2/C4/low_stars_s.txt', /append
...
;  close,2
;  openw,2,'/Users/lbugnet/DATA/METRIC/K2/C4/high_stars_s.txt'
;  close,2
;  openw,2, '/Users/lbugnet/DATA/METRIC/K2/C4/high_stars_s.txt', /append
