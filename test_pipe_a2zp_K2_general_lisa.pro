...
path_org_str = '/Users/lbugnet/DATA/METRIC/K2/ALL/'
path_str = path_org_str
file_output_str = 'ALLRESULTS_A2Zp_variab_metrics_Lor_K2_ALL.sav'
bd_stars=[]

freq_inic_gr    = 0.7   ; in muHz
...
;---------------------------------------------------
files_arr=file_search('/Volumes/TEMP/K2/GAP/JOEL/', '*.rescale') ;;; lit tous les fichiers de K2
save,file='/Users/lbugnet/DATA/METRIC/K2/ALL/LIST_id_ALL.sav', files_arr
restore, '/Users/lbugnet/DATA/METRIC/K2/ALL/LIST_id_ALL.sav', /verbose
...
FOR ns = INIC, n_stars_tot-1 DO BEGIN
  ...
  print, ns
  print, n_stars_tot-1
  if n_elements(where(flux lt 0.1)) gt 20 then begin
    ns=ns+1
    print, 'WARNING BAD STAR' 
    goto, restart
  endif
