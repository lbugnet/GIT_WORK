pro compute_metric_line_80j

  device, decomposed=0
  loadct, 39

  ;file 1: Contient les 23000 étoiles de Kepler
  restore, '/Users/lbugnet/DATA/METRIC/KEPLER/80J/RESULTS_A2Zp_variab_metrics_Lor_80j.sav', /verbose ;OUTPUT_A2ZP
...
endelse
  ...
  save, file='/Users/lbugnet/DATA/TABLES/metric_all_stars_80j.sav', xx, yy, res, slope_fit, output_a2zp, output_resize,  out ;=(stars not in common)
  save, file='/Users/lbugnet/DATA/TABLES/masses_stars_80j.sav'    , xx, yy, residuals, threshold, M, flag, kic_s, numax, dnu
  save, file='/Users/lbugnet/DATA/TABLES/stars_OK_80j.sav'    , xx_ok, yy_ok, residuals, threshold, slope_fit, res

  ;SAVE LOW STARS
  ;w_low=where(flag eq 1)
  ;close,1
  ;openw,1,'/Users/lbugnet/DATA/TABLES/low_stars_s_80j.txt'
  ;close,1
  ;openw,1, '/Users/lbugnet/DATA/TABLES/low_stars_s_80j.txt', /append
  ...
  ;close,2
  ;openw,2,'/Users/lbugnet/DATA/TABLES/high_stars_s_80j.txt'
  ;close,2
  ;openw,2, '/Users/lbugnet/DATA/TABLES/high_stars_s_80j.txt', /append
