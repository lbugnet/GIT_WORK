...
;bd_stars=[]
path_org_str = '/Users/lbugnet/DATA/METRIC/K2/C7/'
path_str = path_org_str 
wild_str = 'hlsp_everest_k2_llc_*-c07_kepler_v2.0_lc.txt.clean.res.hipass.rescale'
file_output_str = 'C7RESULTS_A2Zp_variab_metrics_Lor_K2_C7.sav'
bd_stars=[]
...
;read_kepler_dir,'/Volumes/TEMP/K2/GAP/JOEL/C7/rescale_C7/',files_arr,id_stars_arr,wild='hlsp_everest_k2_llc_*-c04_kepler_v2.0_lc.txt.clean.res.hipass.rescale',length=9
files_arr=file_search('/Volumes/TEMP/K2/GAP/JOEL/C7/rescale_C7/*')
save,file='/Users/lbugnet/DATA/METRIC/K2/C7/LIST_id_C7.sav', files_arr
restore, '/Users/lbugnet/DATA/METRIC/K2/C7/LIST_id_C7.sav', /verbose
...
FOR ns = INIC, n_stars_tot-1 DO BEGIN
  ...
  readcol, files_arr[ns], time,flux, FORMAT='D,D', /silent
  ...
  power_arr_ns    = data_arr(1,*)      ; power 
	...
	region, freq_inic_gr_ns, freq_fin_gr_ns, freq_org_ns, power_arr_ns, xmat_ns, ymat_ns, out_metrics=out_metrics_ns ;compiler kadacs (le bon)
