pro compute_metric_line_K2_C6
device, decomposed=0
loadct, 39

;file 1: Contient les etoiles de K2C6
;restore, '/Users/lbugnet/DATA/KEPLER_LC/K002/RESULTS_KADACS_COARSE_CheckSTATUS_filt_polfitseg960.000_20.0000d_ppm0_inpaint20/RESULTS_A2Zp_variab_metrics_Lor.sav', /verbose ;OUTPUT_A2ZP, BD_STARS, slope_fit 
  restore, '/Users/lbugnet/DATA/METRIC/K2/C6/C6RESULTS_A2Zp_variab_metrics_Lor_K2_C6.sav', /verbose
...
readcol, '/Users/lbugnet/DATA/METRIC/K2/C6/A2Z_results_K2_C6_Everest_2017_04_06.txt',kic_s, numax, err_numax,dnu, err_Dnu, Amax, err_Amax,  format='A,A,A,A,A,A,A', /silent
...
for ii=0,n_elements(kic_s(i1))-1 do begin
...
save, file='/Users/lbugnet/DATA/METRIC/K2/C6/metric_all_stars_K2_C6.sav', xx, yy, res, slope_fit, output_a2zp, output_resize,  out ;=(stars not in common) 
save, file='/Users/lbugnet/DATA/METRIC/K2/C6/masses_stars_K2_C6.sav'    , xx, yy, residuals, threshold, flag, kic_s, numax, dnu ;; attention kic_s est pas bon !!!! prendre output_resize[0,*]
;save, file='/Users/lbugnet/DATA/METRIC/K2/C6/stars_OK_K2_C6.sav'    , xx_ok, yy_ok, residuals, threshold, slope_fit, res


;SAVE LOW STARS
;w_low=where(flag eq 1)
;  close,1
;  openw,1,'/Users/lbugnet/DATA/METRIC/K2/C6/low_stars_s.txt'
;  close,1
;  openw,1, '/Users/lbugnet/DATA/METRIC/K2/C6/low_stars_s.txt', /append
...
;  close,2
;  openw,2,'/Users/lbugnet/DATA/METRIC/K2/C6/high_stars_s.txt'
;  close,2
;  openw,2, '/Users/lbugnet/DATA/METRIC/K2/C6/high_stars_s.txt', /append
