...
restore, file='/Users/lbugnet/DATA/METRIC/K2/C6/metric_all_stars_K2_C6.sav', /verbose;, xx, yy, res, slope_fit, output_a2zp, output_resize,  out  ; prédit avec les numax de A2Z, xx=alog(numax)
output_K2=output_resize
numax_guess_K2=dblarr(n_elements(output_K2[*,1]))
numax_guess_K2(*)=10.^((alog10(output_K2[*,1])-res(0))/res(1)) ; calcul de numax pour les etoiles de K2C6
;numax_guess_K2=10.^(numax_guess_K2)

;--- PLOT AND SAVE
;
pp5=plot(10^xx,10^yy,xlog=1,ylog=1,xtitle='log(numax K2C6 predicted)', ytitle='log(Metric by K2)', symbol="o" ,color="black",linestyle="none", title="NUMAX GUESS FOR ALL K2 C6 STARS")
pp5.thick=1
pp5=plot((numax_guess_K2), ((output_K2[*,1])) ,xlog=1,ylog=1,symbol="D", SYM_FILLED=0, color="dark orchid",linestyle="none", /overplot)
pp5.thick=3
pp5.save, '/Users/lbugnet/DATA/METRIC/K2/C6/guess_numax_K2_C6_all.png'
save,file='/Users/lbugnet/DATA/METRIC/K2/C6/guess_numax_K2_C6_all.sav', output_K2, numax_guess_K2
close,2
openw,2,'/Users/lbugnet/DATA/METRIC/K2/C6/guess_numax_K2_C6_all.txt'
close,2
openw,2, '/Users/lbugnet/DATA/METRIC/K2/C6/guess_numax_K2_C6_all.txt', /append
printf,2, 'KIC K2 C6, numax_guess_K2, PSD_metric_K2'
...
restore, '/Users/lbugnet/DATA/METRIC/K2/C6/masses_stars_K2_C6.sav';, donne threshold
;files_arr=file_search('/Volumes/TEMP/K2/GAP/JOEL/C6/rescale_C6/*')
;path_e='/Users/lbugnet/DATA/METRIC/K2/C6/plot_metric_numax_guess_K2_C6_stars_panel_'
;multi_plot_routine_K2_C6, numax_guess_K2,  res, threshold, numax_guess_K2, output_K2[*,1], files_arr, path_e, string(long(output_K2[*,0]))

;---------------------------------------------
;----- plot multiplot stars cluster ----------
;---------------------------------------------

readcol, '/Users/lbugnet/DATA/METRIC/K2/C6/bad_r_K2_C6.txt',  KIC_miss, good_numax_b, numax_b, good_numax_r, numax_r, good_numax_y, numax_y, numax_guess, output, FORMAT='a,a, D,a,D,a, D,D,D'
output_clump=[]
numax_r_keep=[]
numax_guess_keep=[]
kic_miss_keep=[]
...
for ii=0, n_elements(numax_guess_keep)-1 do begin
  files_arr(ii)=file_search('/Volumes/TEMP/K2/GAP/JOEL/C6/rescale_C6/*'+strcompress(kic_miss_keep(ii))+'*')
  ;print, files_arr(ii)
endfor
;stop
...
Thrust_freq = 47.2281
for j=0,6 do p=plot([(Thrust_freq*j),(Thrust_freq*j)],[1000,100000], xlog=1, ylog=1, xr=[10,1000], yr=[1000,100000],/overplot, xtitle='numax_r',linestyle=2, color='dark blue', title='thrusters K2C6')
p.save, '/Users/lbugnet/DATA/METRIC/K2/C6/thruster_r_K2_C6.png'
;p.close
...
close,12
openw,12,'/Users/lbugnet/DATA/METRIC/K2/C6/thruster_r_K2_C6.txt', WIDTH=80
close,12
OpenW, 12, '/Users/lbugnet/DATA/METRIC/K2/C6/thruster_r_K2_C6.txt',  /append
...
close,13
openw,13,'/Users/lbugnet/DATA/METRIC/K2/C6/thruster_r_ok_K2_C6.txt', WIDTH=80
close,13
OpenW, 13, '/Users/lbugnet/DATA/METRIC/K2/C6/thruster_r_ok_K2_C6.txt',  /append
...
;endfor
;;stop
;path_e='/Users/lbugnet/DATA/METRIC/K2/C6/multiplot_metric_clump_K2_C6_stars_panel_'
;multi_plot_routine_K2_C6, numax_guess_keep,  res, threshold, numax_guess_K2, output_K2[*,1], files_arr, path_e, kic_miss_keep
